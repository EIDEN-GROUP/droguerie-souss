...
Déposez ici un à trois enregistrements réels, nommés :
...
Ne reprenez pas le fichier audio de FlippingBook, d'Issuu ou d'un autre
éditeur : ce sont leurs actifs, et ce catalogue est un document commercial.
...
L'enregistrement dure 3,4 s et contient du silence : la liseuse détecte
automatiquement l'attaque et ne joue que la portion utile (~0,5 s). Vous pouvez
donc déposer n'importe quel extrait sans le recadrer au préalable.
