    ...
    >
      <div className="relative aspect-square overflow-hidden bg-cream">
        ...
        <button
          ...
          className="absolute inset-x-3 bottom-3 flex translate-y-16 items-center justify-center gap-2 rounded-full bg-ink px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-paper opacity-0 transition-all duration-300 hover:bg-brand group-hover:translate-y-0 group-hover:opacity-100"
        >
